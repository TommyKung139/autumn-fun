...
- 島語座位圖（`info.html` 的「午宴位置圖」區塊）分兩部分：上半部「九大主題餐檯」是依島語店內看板整理的餐檯位置與主題名稱；下半部「桌次座位圖」是依 Excel「分桌座位圖請參考」工作表整理的桌次相對位置。兩者分別來自不同來源（餐廳看板 vs. 內部規劃表），依動線由上而下排列方便閱讀，但**不是**同一份精確測繪的平面圖，桌檯與餐檯之間的實際相對距離、方位僅供參考，現場請以指標與工作人員指引為準。
