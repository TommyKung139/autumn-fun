...
給同仁查詢自己（或其他同仁）8/29 第二梯秋郊行程的內部小網站：輸入員工編號即可看到集合車站、下午／晚上行程、遊覽車、宴會桌次、高鐵車廂座位（如已排定）與攜眷資訊；另有「出團名單」可依姓名／部門搜尋確認參加人員，以及「梯次總覽／注意事項」頁面（全梯次總覽、本梯重要時程、眷屬價目表、場地與棒球場位置說明）。
...
├── info.html       梯次總覽／重要時程／眷屬價目表／場地與棒球場資訊
├── login.html      通關密碼登入頁
...
- 本系統資料僅涵蓋**第二梯（8/29，經策／數平／作資）**，不含其他梯次同仁的個人行程（「梯次總覽」頁面的其他梯次僅為總表資訊，非個人查詢）。
- 遊覽車、宴會桌次、高鐵車廂座位是從 Excel 的分車表／分桌表／高鐵分車表以姓名比對整理而成；少數同名同仁或表單中僅以部門代稱（尚未填入姓名）的座位，可能查不到或需與梯長確認，頁面上會顯示「尚未排定／請洽梯長」。
